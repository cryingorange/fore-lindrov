---
{"dg-publish":true,"permalink":"/fore-lindrov/2-mechanics/spells/official/3rd-level/linked-glyphs/","dg-note-properties":{"Mechanic Type":"Spell","Spell Level":"3rd","School of Magic":"Abjuration","Components":["Verbal","Somatic","Material (has cost, consumed)"],"Circle Spell":false,"Concentration":false,"Source":"Adventures in the Forgotten Realms","Official":true}}
---
...
**Detection Glyph.** When you cast this spell, you inscribe a detection glyph that later activates a magical effect at the site of a separate, linked glyph. You inscribe the detection glyph either on a surface (such as a table or a section of floor or wall) or within an object that can be closed (such as a book, a scroll, or a treasure chest) to conceal the glyph. The glyph can cover an area no larger than 10 feet in diameter. If the surface or object is moved more than 10 feet from where you cast this spell, the detection glyph is broken, and the spell ends without being triggered.

Both glyphs are nearly [[Fore Lindrov/2. Mechanics/Condition/Invisible\|Invisible]], and finding either requires a successful INT (Investigation) check against your spell save DC.
